...
export class FournisseursController {
  ...
  create(
    ...
    return this.fournisseursService.create(createFournisseurDto, organizationId);
  }
  ...
  findAll(
    @Query() filterDto: FournisseurFilterDto,
    @CurrentOrganization() organizationId: string,
  ) {
    return this.fournisseursService.findAll(organizationId, filterDto);
  }
  ...
  getGlobalStats(@CurrentOrganization() organizationId: string) {
    return this.fournisseursService.getGlobalStats(organizationId);
  }
  ...
  getStats(
    ...
    return this.fournisseursService.getStats(id, organizationId);
  }
  ...
  getDette(
    ...
    return this.fournisseursService.getDette(id, organizationId);
  }
  ...
  findOne(
    ...
    return this.fournisseursService.findOne(id, organizationId);
  }
  ...
  update(
    ...
    return this.fournisseursService.update(id, updateFournisseurDto, organizationId);
  }
  ...
  remove(
    ...
    return this.fournisseursService.remove(id, organizationId);
  }
}

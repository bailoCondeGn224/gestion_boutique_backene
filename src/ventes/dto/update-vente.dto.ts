...
export class UpdateLigneVenteDto {
...
export class UpdateVenteDto {
  ...
  @Type(() => UpdateLigneVenteDto)
  @IsOptional()
  lignes?: UpdateLigneVenteDto[];

  @ApiProperty({ example: 170000, minimum: 0, required: false })
  @IsNumber()
  ...
  @ApiProperty({ example: 'especes', enum: ModePaiement, required: false })
